...
class _AddEditNotePageState extends State<AddEditNotePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: widget.note == null ? Text('Ekle') : Text('Düzenle'),
      ),
              ...
              children: [
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    validator: (val) =>
                        val.trim().isEmpty ? 'Başlık zorunlu' : null,
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    validator: (val) =>
                        val.trim().isEmpty ? 'İçerik zorunlu' : null,
                ...
                ElevatedButton(
                  onPressed: noteList.loading
                      ? null
                      : () => _submit(widget.note == null ? 'ekle' : 'düzenle'),
                  child: Text(
                    widget.note == null ? 'Ekle' : 'Düzenle',
